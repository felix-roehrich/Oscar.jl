...
import ..Oscar:
  coeff, coefficient_ring, expressify, gen, gens, leading_coefficient, leading_exponent_vector, leading_monomial, length, ngens, parent, setcoeff!, trailing_coefficient
