...
function add!(z::PBWAlgebraModuleElem{T}, x::PBWAlgebraModuleElem{T}, y::PBWAlgebraModuleElem{T}) where {T}
  add!(z.elem, x.elem, y.elem)
  return z
end

function mul!(z::PBWAlgebraModuleElem{T}, x::PBWAlgebraElem{T}, m::PBWAlgebraModuleElem{T}) where {T}
